...
@router.get("/{schema}/equipo_proceso/all")
def list_all( schema: Optional[str], request: Request, id_tipo_fuente: str,
...
@router.get("/{schema}/equipo_proceso/", response_model=PaginacionSchema)
...
@router.post("/{schema}/equipo_proceso/")
...
@router.get("/{schema}/equipo_proceso/{equipo_id}")
def get_show(schema: Optional[str], request: Request, equipo_id: int, 
                db: Session = Depends(get_db),
                tokenpayload: dict = Depends(verify_jwt_token)):
    schema = request.state.schema
...
@router.put("/{schema}/equipo_proceso/{equipo_id}")
...
@router.delete("/{schema}/equipo_proceso/{equipo_id}")
...
@router.post("/{schema}/equipo_proceso/{equipo_id}/reactivate")

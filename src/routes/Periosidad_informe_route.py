...
@router.get("/{schema}/periosidad/all")
...
@router.get("/{schema}/periosidad/", response_model=PaginacionSchema)
...
@router.get("/{schema}/periosidad/{periosidad_informe_id}")
def get_show(schema: Optional[str], request: Request, periosidad_informe_id: int, 
                db: Session = Depends(get_db),
                tokenpayload: dict = Depends(verify_jwt_token)):
    schema = request.state.schema
...
@router.put("/{schema}/periosidad/{periosidad_informe_id}")
...
@router.delete("/{schema}/periosidad/{periosidad_informe_id}")
...
@router.post("/{schema}/periosidad/{periosidad_informe_id}/reactivate")

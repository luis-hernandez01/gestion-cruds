...
@router.get("/{schema}/tipo_fuentes/all")
...
@router.get("/{schema}/tipo_fuentes/", response_model=PaginacionSchema)
...
@router.post("/{schema}/tipo_fuentes/")
...
@router.get("/{schema}/tipo_fuentes/{tipofuentes_id}")
def get_show(schema: Optional[str], request: Request, tipofuentes_id: int, 
                db: Session = Depends(get_db),
                tokenpayload: dict = Depends(verify_jwt_token)):
    schema = request.state.schema
...
@router.put("/{schema}/tipo_fuentes/{tipofuentes_id}")
...
@router.delete("/{schema}/tipo_fuentes/{tipofuentes_id}")
...
@router.post("/{schema}/tipo_fuentes/{tipofuentes_id}/reactivate")

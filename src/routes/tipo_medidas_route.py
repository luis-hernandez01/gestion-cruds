...
@router.get("/{schema}/tipo_medida/all")
...
@router.get("/{schema}/tipo_medida/", response_model=PaginacionSchema)
...
@router.post("/{schema}/tipo_medida/")
...
@router.get("/{schema}/tipo_medida/{tipo_medida_id}")
def get_show(schema: Optional[str], request: Request, tipo_medida_id: int, 
                db: Session = Depends(get_db),
                tokenpayload: dict = Depends(verify_jwt_token)):
    schema = request.state.schema
...
@router.put("/{schema}/tipo_medida/{tipo_medida_id}")
...
@router.delete("/{schema}/tipo_medida/{tipo_medida_id}")
...
@router.post("/{schema}/tipo_medida/{tipo_medida_id}/reactivate")

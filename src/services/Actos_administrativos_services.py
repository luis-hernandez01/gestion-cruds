...
from src.schemas.Actos_administrativos_schema import Actos_administrativoCreate, Actos_administrativoUpdate, LogEntityRead
from datetime import datetime
from src.utils.logs_util import LogUtil
from sqlalchemy import asc
from src.config.dinamic_tables import get_Actos_administrativos_table

# Servicio para listar las unidades de ejecucion
class ActosadminService:
    def __init__(self, db: Session, schema: str):
        self.db = db
        self.schema = schema
        self.table = get_Actos_administrativos_table(schema)
...
# servicio para listar  los registros
    ...
    def create(self, payload: Actos_administrativoCreate, 
        ...
        LogUtil(self.db, self.schema).registrar_log(
            tabla_afectada="actos_administrativos",

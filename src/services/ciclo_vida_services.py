...
from src.schemas.Ciclo_vida_schema import Ciclo_vidaCreate, Ciclo_vidaUpdate, LogEntityRead
from datetime import datetime
from src.utils.logs_util import LogUtil
from sqlalchemy import asc
from src.config.dinamic_tables import get_Ciclo_vida_table

# Servicio para listar las unidades de ejecucion
class CiclovidaService:
    def __init__(self, db: Session, schema: str):
        self.db = db
        self.schema = schema
        self.table = get_Ciclo_vida_table(schema)
...
# servicio para listar  los registros
    ...
    def create(self, payload: Ciclo_vidaCreate, 

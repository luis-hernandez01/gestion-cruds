...
from src.schemas.Periosidad_informe_schema import Periosidad_informeCreate, Periosidad_informeUpdate, LogEntityRead
from datetime import datetime
from src.utils.logs_util import LogUtil
from sqlalchemy import asc
from src.config.dinamic_tables import get_Periosidad_informe_table

# Servicio para listar las unidades de ejecucion
class periosidadService:
    def __init__(self, db: Session, schema: str):
        self.db = db
        self.schema = schema
        self.table = get_Periosidad_informe_table(schema)
...
# servicio para listar  los registros
    ...
    def create(self, payload: Periosidad_informeCreate, 
        ...
        LogUtil(self.db, self.schema).registrar_log(
            tabla_afectada="periosidad_informe",

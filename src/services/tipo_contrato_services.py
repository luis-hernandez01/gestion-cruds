...
from src.schemas.Tipo_contrato_schema import Tipo_contratoCreate, Tipo_contratoUpdate, LogEntityRead
from datetime import datetime
from src.utils.logs_util import LogUtil
from sqlalchemy import asc
from src.config.dinamic_tables import get_Tipo_contrato_table

# Servicio para listar las unidades de ejecucion
class Tipo_contratoService:
    def __init__(self, db: Session, schema: str):
        self.db = db
        self.schema = schema
        self.table = get_Tipo_contrato_table(schema)
...
# servicio para listar  los registros
    ...
    def create(self, payload: Tipo_contratoCreate, 

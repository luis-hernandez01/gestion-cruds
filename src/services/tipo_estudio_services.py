...
from src.schemas.Tipo_estudio_ambiental_schema import Tipo_estudio_ambientalCreate, Tipo_estudio_ambientalUpdate, LogEntityRead
from datetime import datetime
from src.utils.logs_util import LogUtil
from sqlalchemy import asc
from src.config.dinamic_tables import get_Tipo_estudio_ambiental_table

# Servicio para listar las unidades de ejecucion
class Tipo_estudioService:
    def __init__(self, db: Session, schema: str):
        self.db = db
        self.schema = schema
        self.table = get_Tipo_estudio_ambiental_table(schema)
...
# servicio para listar  los registros
    ...
    def create(self, payload: Tipo_estudio_ambientalCreate, 
        ...
        LogUtil(self.db, self.schema).registrar_log(
            tabla_afectada="tipo_estudio_ambiental",

...
from src.schemas.Tipofuente_schema import TipofuenteCreate, TipofuenteUpdate, LogEntityRead
...
class TipofuenteService:
    def __init__(self, db: Session, schema: str):
        self.db = db
        self.schema = schema
        self.table = get_Tipofuente_table(schema)
...
# servicio para listar  los registros
    ...
    def create(self, payload: TipofuenteCreate, 

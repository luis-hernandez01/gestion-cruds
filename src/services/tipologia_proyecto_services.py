...
from src.schemas.Tipologia_proyecto_schema import Tipologia_proyectoCreate, Tipologia_proyectoUpdate, LogEntityRead
from datetime import datetime
from src.utils.logs_util import LogUtil
from sqlalchemy import asc
from src.config.dinamic_tables import get_Tipologia_proyecto_table

# Servicio para listar las unidades de ejecucion
class Tipologia_proyectoService:
    def __init__(self, db: Session, schema: str):
        self.db = db
        self.schema = schema
        self.table = get_Tipologia_proyecto_table(schema)
...
# servicio para listar  los registros
    ...
    def create(self, payload: Tipologia_proyectoCreate, 
        ...
        LogUtil(self.db, self.schema).registrar_log(
            tabla_afectada="tipologia_proyecto",
